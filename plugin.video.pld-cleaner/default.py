...
def Main():
	...
	addDir('[COLOR blue]BORRAR CACHE[/COLOR]','0',1000,iconhdm, fanart)
	addDir('[COLOR blue]BORRAR PAQUETES[/COLOR]','0',1001,icons, fanart)
	addDir('[COLOR blue]BORRAR DATA[/COLOR]','0',1002,iconts, fanart)
